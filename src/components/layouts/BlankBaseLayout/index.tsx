    ...
    return (
        <div className={classNames('sb-page', pageMeta.pageCssClasses)} data-sb-object-id={pageMeta.id}>
            <Head>
                ...
                <meta name="description" content="Premier on-location wedding Makeup and Hair Service for Minneapolis and St. Paul. Bridal hair and makeup, NovaLash Eyelash Extensions, airbrush makeup, and more." />
