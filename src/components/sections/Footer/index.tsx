                        ...
                        {(socialLinks.length > 0 || props.contacts) && (
                            <div className="mb-6">
                                {socialLinks.length > 0 && (
                                    <ul className="flex justify-end mb-6 space-x-10" data-sb-field-path=".socialLinks">
...
function Contacts(props) {
    return (
        <div className="mb-6 space-y-4 text-lg grid justify-items-end" data-sb-field-path=".contacts">
            {props.phoneNumber && (
                <p>
                    <a
