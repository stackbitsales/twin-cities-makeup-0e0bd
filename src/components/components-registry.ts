...
const components = {
    ...
    'MapSection': dynamic(() => import('./sections/MapSection')),
    ...
    'SubmitReviewsSection': dynamic(() => import('./molecules/FormBlock/SubmitReviewsSection')),
    ...
    'YouTubeSection': dynamic(() => import('./sections/YouTubeSection'))
};
